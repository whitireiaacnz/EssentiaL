...
namespace EssentialWeb.App_Code
{
    public class LoginUser
    {
        ...
        public static string UserLogoutURL = "~/userlogout.aspx";
        public void ValidateLogin(String Name, String Password, ref int admin_id, ref String Email, ref int Level_Id)
        {
            ...
            if (!DBNull.Value.Equals(sqlpara[2].Value))
            {
        ...
        public static DataSet login(string Name, string Password, int admin_id, string Email, int Level_Id)
        {
