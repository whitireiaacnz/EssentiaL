<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.Master" AutoEventWireup="true" CodeBehind="brandview.aspx.cs" Inherits="EssentialWeb.brandview" %>
...
<%--                            <dx:ASPxButton ID="ASPxButton1" runat="server" Text="Get Value" OnClick="ASPxButton1_Click"/>
                    <dx:ASPxLabel ID="ASPxLabel1" runat="server" ClientInstanceName="label" Text="Test"/>--%>
                            
                            
                            <dx:ASPxGridView ID="dg" ClientInstanceName="dg" runat="server" Width="100%" EnableRowsCache="False" KeyFieldName="Brand_Id"
                        OnCustomCallback="dg_CustomCallback" OnStartRowEditing="dg_StartRowEditing"  OnRowDeleting="dg_RowDeleting"                                          
                        OnLoad="dg_Load" OnCustomErrorText="dg_CustomErrorText" >
                  
                                    <settings showfilterrow="True" showgrouppanel="True" showfilterrowmenu="true" showpreview="true" ></settings>
                                    <settingscookies enabled="false" />
                                    <settingsbehavior confirmdelete="true" columnresizemode="NextColumn" AllowSelectSingleRowOnly="true" AllowSelectByRowClick="true" />
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn FieldName="Brand_Name" Caption="Brand Name" Width="20%" Settings-AllowGroup="true" ReadOnly="false">
