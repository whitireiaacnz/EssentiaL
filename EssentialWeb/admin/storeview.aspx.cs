...
namespace EssentialWeb.admin
{
    public partial class storeview : System.Web.UI.Page
    {
        ...
        int recid, Flag;
        private string NewScheduleRedirect = @"~/admin/store.aspx";
        ...
        private void ApplyLayout(int layoutIndex)
        {
            ...
            try
            {
                ...
                switch (layoutIndex)
                {
                    case 1:
                        {
                            dg.GroupBy(dg.Columns["Store_Name"]);
                            break;
                        }
        ...
        {
            int id = Convert.ToInt32(dg.GetRowValuesByKeyValue(e.EditingKeyValue, "Store_Id"));
        ...
        {
            int id = Convert.ToInt32(e.Keys["Store_Id"]);
            objCommon.DeleteMasters("tbl_Store", "Store_Id", id, true);
            e.Cancel = true;
            ScheduleDisplay();
        }
