...
namespace EssentialWeb.admin
{
    public partial class categoryview : System.Web.UI.Page
    {
        ...
        int recid, Flag;
        private string NewScheduleRedirect = @"~/admin/category.aspx";
        ...
        {
            int id = Convert.ToInt32(dg.GetRowValuesByKeyValue(e.EditingKeyValue, "Category_Id"));
        ...
        {
            int id = Convert.ToInt32(e.Keys["Category_Id"]);
            objCommon.DeleteMasters("tbl_Category", "Category_Id", id, true);
            e.Cancel = true;
            ScheduleDisplay();
