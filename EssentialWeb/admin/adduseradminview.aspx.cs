...
{
    public partial class adduseradminview : System.Web.UI.Page
    {
        ...
        int recid, Flag;
        private string NewScheduleRedirect = @"~/admin/adduseradmin.aspx";
        ...
        protected int GridPageSize
        {
            get
            {
                ...
                return System.Convert.ToInt32(Session["Adminlogin"]);
            }
            set
            {
                Session["Adminlogin"] = value;
            }
        }
        protected void dg_StartRowEditing(object sender, DevExpress.Web.Data.ASPxStartRowEditingEventArgs e)
        {
            int id = Convert.ToInt32(dg.GetRowValuesByKeyValue(e.EditingKeyValue, "admin_id"));
        ...
        {
            int id = Convert.ToInt32(e.Keys["admin_id"]);
            objCommon.DeleteMasters("tbl_user", "admin_id", id, true);
            e.Cancel = true;
            ScheduleDisplay();
