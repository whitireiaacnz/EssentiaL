...
namespace EssentialWeb.admin
{
    public partial class groupview : System.Web.UI.Page
    {
        ...
        int recid, Flag;
        private string NewScheduleRedirect = @"~/admin/group.aspx";
          ...
          private void ApplyLayout(int layoutIndex)
          {
              ...
              try
              {
                  ...
                  switch (layoutIndex)
                  {
                      case 1:
                          {
                              dg.GroupBy(dg.Columns["Group_Name"]);
                              break;
                          }
        ...
        {
            int id = Convert.ToInt32(dg.GetRowValuesByKeyValue(e.EditingKeyValue, "Group_Id"));
        ...
        {
            int id = Convert.ToInt32(e.Keys["Group_Id"]);
            objCommon.DeleteMasters("tbl_Group", "Group_Id", id, true);
            e.Cancel = true;
            ScheduleDisplay();
