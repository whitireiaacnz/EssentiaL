...
{
    public partial class brandview : System.Web.UI.Page
    {
       // string ret = view.GetRowCellValue(view.FocusedRowHandle, view.Columns[0]).ToString();
        ...
        int recid, Flag;
        private string NewScheduleRedirect = @"~/admin/brand.aspx";
        ...
        private void ApplyLayout(int layoutIndex)
        {
            ...
            try
            {
                ...
                switch (layoutIndex)
                {
                    case 1:
                        {
                            dg.GroupBy(dg.Columns["Brand_Name"]);
                            break;
                        }
        ...
        {
            int id = Convert.ToInt32(dg.GetRowValuesByKeyValue(e.EditingKeyValue, "Brand_Id"));
        ...
        {
            int id = Convert.ToInt32(e.Keys["Brand_Id"]);
            objCommon.DeleteMasters("tbl_Brand", "Brand_Id", id, true);
            e.Cancel = true;
            ScheduleDisplay();
        }
        ...
        //protected void dg_FocusedRowChanged(object sender, EventArgs e)
        //{
        //    ASPxGridView grid = (ASPxGridView)sender;
        //    object value = grid.GetRowValues(grid.FocusedRowIndex, "Brand_Name");  
        //}
        private void dg_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
