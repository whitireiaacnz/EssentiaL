<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.Master" AutoEventWireup="true" CodeBehind="schemeview.aspx.cs" Inherits="EssentialWeb.admin.schemeview" %>
     ...
     <div id="review_form" style="padding: 10px 20px 10px 20px" class="col-inner">
        <div class="review-form-inner has-border">
            ...
            <h3>Scheme View</h3>
              ...
              <dx:ASPxGridView ID="dg" ClientInstanceName="dg" runat="server" Width="100%" EnableRowsCache="False" KeyFieldName="Scheme_Id"
                        OnCustomCallback="dg_CustomCallback" OnStartRowEditing="dg_StartRowEditing1"  OnRowDeleting="dg_RowDeleting"                                          
                        OnLoad="dg_Load" OnCustomErrorText="dg_CustomErrorText">
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn FieldName="Scheme_Name" Caption="Scheme Name" Width="30%" Settings-AllowGroup="true">
                                        <Settings AutoFilterCondition="Contains" />
                                    </dx:GridViewDataTextColumn>
                                    
                                    <dx:GridViewDataTextColumn FieldName="msp" Caption="Market Selling Price in percent(%)" Width="20%" Settings-AllowGroup="true">
                                        <Settings AutoFilterCondition="Contains" />
                                    </dx:GridViewDataTextColumn>
                                    
                                    <dx:GridViewDataTextColumn FieldName="bp" Caption="Best Price percent(%)" Width="30%" Settings-AllowGroup="true">
                                        <Settings AutoFilterCondition="Contains" />
                                    </dx:GridViewDataTextColumn>
                                    
                                    <dx:GridViewDataDateColumn FieldName="isActive" Caption="isActive" Width="15%" Visible="true" Settings-AllowGroup="True">
                                        <Settings AutoFilterCondition="Contains" />
