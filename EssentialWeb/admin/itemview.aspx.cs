...
namespace EssentialWeb.admin
{
    public partial class itemview : System.Web.UI.Page
    {
        ...
        int recid, Flag;
        private string NewScheduleRedirect = @"~/admin/item.aspx";
        ...
        private void ApplyLayout(int layoutIndex)
        {
            ...
            try
            {
                ...
                switch (layoutIndex)
                {
                    case 1:
                        {
                            dg.GroupBy(dg.Columns["Color"]);
                            break;
                        }

                    case 2:
                        {
                            dg.GroupBy(dg.Columns["ModelNo"]);
                            break;
                        }
                    case 3:
                        {
        ...
        {
            int id = Convert.ToInt32(dg.GetRowValuesByKeyValue(e.EditingKeyValue, "Item_Id"));
        ...
        {
            int id = Convert.ToInt32(e.Keys["Item_Id"]);
            objCommon.DeleteMasters("tbl_Item", "Item_Id", id, true);
            e.Cancel = true;
            ScheduleDisplay();
        }
        ...
        //{
        //    var products = dg.GetSelectedFieldValues("Brand_Name");
        //    ASPxLabel1.Text = products[2].ToString();
        //}

        //protected void dg_SelectedIndexChanged(object sender, EventArgs e)
        //{
        //    text.Text = dg.SelectedRow.Cells[0].Text;
        ...
        private void dg_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            object value = grid.GetRowValues(grid.FocusedRowIndex, "Item_Name");
