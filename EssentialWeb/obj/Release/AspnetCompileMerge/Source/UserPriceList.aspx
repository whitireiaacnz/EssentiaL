<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="UserPriceList.aspx.cs" Inherits="EssentialWeb.UserPriceList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content2" runat="server">
     <div id="review_form" style="padding: 10px 20px 10px 20px" class="col-inner">
        <div class="review-form-inner has-border">
            ...
            <h3 class="text-primary">Price List</h3>
        </div>
...
<%--                                <td style="padding-right: 4px">
              ...
              <dx:ASPxGridView ID="dg" ClientInstanceName="dg" runat="server" Width="100%" EnableRowsCache="False" KeyFieldName="PriceList_Id"
                        OnCustomCallback="dg_CustomCallback" OnStartRowEditing="dg_StartRowEditing"  OnRowDeleting="dg_RowDeleting"                                          
                        OnLoad="dg_Load" OnCustomErrorText="dg_CustomErrorText" CssClass="text-primary" Styles-Header-CssClass="text-danger">
                                ...
                                <Columns>
                                    <%--<dx:GridViewCommandColumn VisibleIndex="0" Caption=" " Width="2%">
                                        ...
                                        <EditButton Visible="False" Text="Update"/>                                       
