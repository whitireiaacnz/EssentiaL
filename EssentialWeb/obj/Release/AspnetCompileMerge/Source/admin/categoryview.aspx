<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.Master" AutoEventWireup="true" CodeBehind="categoryview.aspx.cs" Inherits="EssentialWeb.admin.categoryview" %>
...
<%--                                <td style="padding-right: 4px">
                        ...
                        OnLoad="dg_Load" OnCustomErrorText="dg_CustomErrorText">--%>
                                    <dx:ASPxGridView ID="dg" ClientInstanceName="dg" runat="server" Width="100%" EnableRowsCache="False" KeyFieldName="Category_Id"
                        OnCustomCallback="dg_CustomCallback" OnStartRowEditing="dg_StartRowEditing"  OnRowDeleting="dg_RowDeleting"                                          
                        OnLoad="dg_Load" OnCustomErrorText="dg_CustomErrorText">
                                ...
                                <Columns>
                                    <dx:GridViewCommandColumn VisibleIndex="0" Caption=" " Width="1%">
                                        <ClearFilterButton Visible="true" />
                                        <EditButton Visible="true" Text="Update"/>                                       
                                        <DeleteButton Visible="true" />
                                    </dx:GridViewCommandColumn>                                                             
                         
                                    <dx:GridViewDataTextColumn FieldName="Category_Name" Caption="Category Name" Width="3%" Settings-AllowGroup="true">
                                        <Settings AutoFilterCondition="Contains" />
                                    </dx:GridViewDataTextColumn>

                                        <dx:GridViewDataTextColumn FieldName="Group_Name" Caption="Group Name" Width="3%" Settings-AllowGroup="true">
                                        <Settings AutoFilterCondition="Contains" />
                                    </dx:GridViewDataTextColumn>

                                     <dx:GridViewDataTextColumn FieldName="isActive" Caption="isActive" Width="2%" Settings-AllowGroup="true">
                                        <Settings AutoFilterCondition="Contains" />
                                    </dx:GridViewDataTextColumn>
