<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.Master" AutoEventWireup="true" CodeBehind="pricelistview.aspx.cs" Inherits="EssentialWeb.pricelistview" %>
  ...
  <div id="review_form" style="padding: 10px 20px 10px 20px" class="col-inner">
        <div class="review-form-inner has-border">
            ...
            <h3>Price List View</h3>
              ...
              <dx:ASPxGridView ID="dg" ClientInstanceName="dg" runat="server" Width="100%" EnableRowsCache="False" KeyFieldName="PriceList_Id"
                        OnCustomCallback="dg_CustomCallback" OnStartRowEditing="dg_StartRowEditing"  OnRowDeleting="dg_RowDeleting"                                          
                        OnLoad="dg_Load" OnCustomErrorText="dg_CustomErrorText">
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn FieldName="Item_Name" Caption="Item Name" Width="5%" Settings-AllowGroup="true">
                                    ...
                                    <dx:GridViewDataTextColumn FieldName="Scheme_Name" Caption="Scheme Name" Width="3%" Settings-AllowGroup="true">
                                        <Settings AutoFilterCondition="Contains"/>
                                    </dx:GridViewDataTextColumn>

                                     <dx:GridViewDataTextColumn FieldName="IsApplicableFrom" Caption="IsApplicableFrom" Width="3%" Settings-AllowGroup="true">
                                        <Settings AutoFilterCondition="Contains" />
                                    </dx:GridViewDataTextColumn>
                                    
                                    <dx:GridViewDataTextColumn FieldName="DP" Caption="Display Price" Width="20" Settings-AllowGroup="true">
                                        <Settings AutoFilterCondition="Contains" />
                                    </dx:GridViewDataTextColumn>

                                     <dx:GridViewDataTextColumn FieldName="MSP" Caption="Minimum Support Price" Width="2%" Settings-AllowGroup="true">
                                        <Settings AutoFilterCondition="Contains" />
                                    </dx:GridViewDataTextColumn>
                                    ...
                                    <dx:GridViewDataDateColumn FieldName="isActive" Caption="isActive" Width="1%" Visible="true" Settings-AllowGroup="True">
                                        <Settings AutoFilterCondition="Contains" />
