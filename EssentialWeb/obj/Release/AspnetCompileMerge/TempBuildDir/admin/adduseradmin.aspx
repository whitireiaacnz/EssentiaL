...
<center>
    ...
    <div class="col-sm-3" style="padding-top:10px;"> <label for="ddladminuser" class="" style="line-height:0px;text-align:center;"></label></div>
 <asp:DropDownList ID="ddladminuser" runat="server"  CssClass="form-control dropdown-toggle"  AutoPostBack="true"></asp:DropDownList><br />
    <center> <asp:RequiredFieldValidator runat="server" InitialValue = "Select User type" ControlToValidate="ddladminuser" ErrorMessage="Please Select User/Admin" ForeColor="Red"></asp:RequiredFieldValidator> </center>
