<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.Master" AutoEventWireup="true" CodeBehind="adduseradminview.aspx.cs" Inherits="EssentialWeb.admin.adduseradminview" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content2" runat="server">
     ...
     <div id="review_form" style="padding: 10px 20px 10px 20px" class="col-inner">
        <div class="review-form-inner has-border">
            <div class="pages">
                <%--<h1>Feedback View</h1>--%>
                <div style="text-align: center; color:rgba(0, 0, 0, 0.92); font-weight:bolder;">
          <h2>User List </h2>
        </div>
              ...
              <dx:ASPxGridView ID="dg" ClientInstanceName="dg" runat="server" Width="100%" EnableRowsCache="False" KeyFieldName="admin_id"
                        OnCustomCallback="dg_CustomCallback" OnStartRowEditing="dg_StartRowEditing"  OnRowDeleting="dg_RowDeleting"                                          
                        OnLoad="dg_Load" OnCustomErrorText="dg_CustomErrorText">
                                ...
                                <Columns>
                                    <dx:GridViewCommandColumn VisibleIndex="0" Caption=" " Width="15%">
                                    ...
                                    <dx:GridViewDataTextColumn FieldName="Name" Caption=" Name" Width="20%" Settings-AllowGroup="true">
                                        <Settings AutoFilterCondition="Contains" />
                                    </dx:GridViewDataTextColumn>


                                    <dx:GridViewDataDateColumn FieldName="Email" Caption="Email" Width="40%" Visible="true" Settings-AllowGroup="True">
                                        <Settings AutoFilterCondition="Contains" />
                                    </dx:GridViewDataDateColumn>

                              
                                    <dx:GridViewDataDateColumn FieldName="Mobile" Caption="Mobile" Width="40%" Visible="true" Settings-AllowGroup="True">
                                        <Settings AutoFilterCondition="Contains" />
                                    </dx:GridViewDataDateColumn>

                                     <dx:GridViewDataDateColumn FieldName="LevelName" Caption="User Type" Width="40%" Visible="true" Settings-AllowGroup="True">
                                        <Settings AutoFilterCondition="Contains" />
                                    </dx:GridViewDataDateColumn>
                                    
                                     <dx:GridViewDataTextColumn FieldName="isActive" Caption="isActive" Width="12%" Settings-AllowGroup="true">
                                        <Settings AutoFilterCondition="Contains" />
                                    </dx:GridViewDataTextColumn>
