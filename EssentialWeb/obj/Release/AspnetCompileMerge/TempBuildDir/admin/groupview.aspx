<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.Master" AutoEventWireup="true" CodeBehind="groupview.aspx.cs" Inherits="EssentialWeb.admin.groupview" %>
                ...
                <section class="bg-white one-col">
                    <section class="bg-white-border">
                        ...
                        OnLoad="dg_Load" OnCustomErrorText="dg_CustomErrorText">--%>
                                    <dx:ASPxGridView ID="dg" ClientInstanceName="dg" runat="server" Width="100%" EnableRowsCache="False" KeyFieldName="Group_Id"
                        OnCustomCallback="dg_CustomCallback" OnStartRowEditing="dg_StartRowEditing"  OnRowDeleting="dg_RowDeleting"                                          
                        OnLoad="dg_Load" OnCustomErrorText="dg_CustomErrorText">
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn FieldName="Group_Name" Caption="Group Name" Width="60%" Settings-AllowGroup="true">
                                        <Settings AutoFilterCondition="Contains" />
                                    </dx:GridViewDataTextColumn>

                                      <dx:GridViewDataTextColumn FieldName="isActive" Caption="isActive" Width="20%" Settings-AllowGroup="true">
                                        <Settings AutoFilterCondition="Contains" />
                                    </dx:GridViewDataTextColumn>
